...
try:
	...
	nasa_api_key = config.get('nasa', 'e32iR2e5RroDvi3hazdLNceh8WDuAFLEHIuROFdJ')
	nasa_api_url = config.get('nasa', 'https://api.nasa.gov/planetary/apod?api_key=e32iR2e5RroDvi3hazdLNceh8WDuAFLEHIuROFdJ')
